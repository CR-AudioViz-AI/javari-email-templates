...
// Javari Email Templates — AI Generation API
...
const SYSTEM_PROMPT = `You are an email marketing expert for CR AudioViz AI. Create high-converting email templates for any business purpose. Optimize subject lines, preview text, CTAs, and copy. Include A/B testing suggestions.`
